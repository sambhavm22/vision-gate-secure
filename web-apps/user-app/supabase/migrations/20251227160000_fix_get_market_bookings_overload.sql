-- Drop potentially conflicting overloads
DROP FUNCTION IF EXISTS public.get_market_bookings(uuid);
DROP FUNCTION IF EXISTS public.get_market_bookings(uuid, int);
DROP FUNCTION IF EXISTS public.get_market_bookings(uuid, int, int); -- For the error message signature

-- Copy of the function from 20251224151300_zip_centroid_fallback.sql
