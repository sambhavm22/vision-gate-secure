...
import { Card, CardContent } from "@vision-gate/ui";
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">
            Why people use HelperHub
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center group cursor-pointer">
              <div className="w-20 h-20 rounded-2xl bg-red-50 flex items-center justify-center mb-6 border-2 border-red-100 group-hover:bg-red-100 group-hover:border-red-200 transition-all shadow-sm">
                <Users className="h-10 w-10 text-red-500" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-slate-900">Maid didn’t come?</h3>
              <p className="text-muted-foreground text-lg">Get instant help.</p>
            </div>

            <div className="flex flex-col items-center text-center group cursor-pointer">
              <div className="w-20 h-20 rounded-2xl bg-orange-50 flex items-center justify-center mb-6 border-2 border-orange-100 group-hover:bg-orange-100 group-hover:border-orange-200 transition-all shadow-sm">
                <Star className="h-10 w-10 text-orange-500" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-slate-900">Guests at home?</h3>
              <p className="text-muted-foreground text-lg max-w-xs">Hire quick assistance for cleaning, cooking, utensils.</p>
            </div>

            <div className="flex flex-col items-center text-center group cursor-pointer">
              <div className="w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center mb-6 border-2 border-blue-100 group-hover:bg-blue-100 group-hover:border-blue-200 transition-all shadow-sm">
                <Clock className="h-10 w-10 text-blue-500" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-slate-900">Washing machine broken?</h3>
              <p className="text-muted-foreground text-lg">Book laundry support.</p>
            </div>
          </div>
        </div>
      </section>
