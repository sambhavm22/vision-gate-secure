...
import { ArrowLeft, Loader2, LogOut, MapPin, Moon, Plus, Save, Sun, X } from "lucide-react";
...
export default function Profile() {
    ...
    const handleUpdateServices = async (newServices: string[]) => {
        ...
        try {
            ...
            toast({ title: "Services Updated", description: "Your service list has been updated." });
            await refreshProfile();
        } catch (error: any) {
            toast({ variant: "destructive", title: "Update Failed", description: error.message });
        } finally {
